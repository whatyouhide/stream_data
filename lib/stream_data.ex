defmodule StreamData do
  ...
  @doc """
  Generates a simple term.

  A simple term is a term that can be generated by `StreamData` and hat doesn't enclose any other
  terms. For example, an integer is a simple term but a list isn't (since it can enclose other
  simple terms such as integers). The simple terms that this generator can generated are:
  ...
  ## Examples
    ...
    Enum.take(StreamData.simple_term(), 3)
    #=> [0.5119003572251588, "", :WJg]
