defmodule StreamData do
  ...
  The frequency distribution can be specified using the `ratio` keyword
  argument. It defaults to 0.5, meaning that the result will be `nil` half the
  time. A ratio of 0.25 means that `nil` is selected 1/4th of the time and
  `data` is selected 3/4th of the time.
