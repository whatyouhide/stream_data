defmodule StreamData do
  ...
  `data_map` is a map of `fixed_key => data` pairs. Maps generated by this generator will have a
  subset of the keys of `data_map` and values corresponding to the values generated by the
  generator unders those keys.
